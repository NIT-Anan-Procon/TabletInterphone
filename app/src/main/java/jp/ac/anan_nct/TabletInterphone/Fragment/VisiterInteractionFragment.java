...
public class VisiterInteractionFragment extends BaseFragment {
    ...
    protected void onCreate(View view) {
        ...
        view.findViewById(R.id.ModeLayout).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
	...
	*/
    ...
    private void modeChange(View  view){
        Resources r = getResources();
        Drawable mode;
        if ( modeStatus == 0) {
            mode = r.getDrawable(R.drawable.home);
        } else if ( modeStatus == 1) {
            mode = r.getDrawable(R.drawable.moon);
        } else {
            mode = r.getDrawable(R.drawable.outdoor);
        }
        ImageView modeImg = (ImageView) view.findViewById(R.id.mode);
        modeImg.setImageDrawable(mode);
    }

...
public class OutsideConnectSettingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //KeyBoxBluetoothSettingButton = (Button) findViewById(R.id.BluetoothSettingButton);
    ...
    private void startConnect() {
       ...
       // bluetoothStatus = BluetoothStatus.NODEVICE;
        ...
        progressDialog.setMessage(wifiStatus.toString());
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                synchronized (dialog) {
                    if (!dialog.isShowing()) {
                    ...
                    } else if (wifiStatus == WifiStatus.CONNECTED) { //両方接続完了
                        dialog.dismiss();
                        startOutside();
                        ...
                        dialog.setMessage(wifiStatus.toString());
                    }
                }
            }
        });
    ...
    private void showIpAddressDialog(boolean b) {
        ...
        ipAddressPicker[0].setValue(id1);
        ipAddressPicker[1].setValue(id2);
        ipAddressPicker[2].setValue(id3);
        ipAddressPicker[3].setValue(id4);

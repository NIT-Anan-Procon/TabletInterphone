        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_settings:
                if (sharedVariable.bluetoothConnection != null) {
                    startActivity(new Intent(VisiterCheckActivity.this, InsideSettingActivity.class));
                } else {
            ...
            case R.id.open_key:
                sharedVariable.wifiSocket.writeObject(Const.INTERACTION_OPEN_KEY);
                sharedVariable.writeReaction("キーボックス開錠");
                return true;
